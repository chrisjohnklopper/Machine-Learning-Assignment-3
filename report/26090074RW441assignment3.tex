...
\begin{table}[H]
	...
	\resizebox{\columnwidth}{!}{
		\csvautobooktabular{../csv-descriptions/power-description-numerical.csv}
	}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/weather-multirnn-h32-actual-vs-predicted.pdf}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/airquality-elman-h32-actual-vs-predicted.pdf}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/airquality-jordan-h32-actual-vs-predicted.pdf}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/airquality-multirnn-h32-actual-vs-predicted.pdf}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/power-elman-h32-actual-vs-predicted.pdf}
...
\begin{figure}[H] 
	\centering
	\includegraphics[width=1.0\linewidth]{../images/power-multirnn-h32-actual-vs-predicted.pdf}
